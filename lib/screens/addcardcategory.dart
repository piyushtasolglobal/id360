...
class AddCardCategory extends StatefulWidget {
  @override
  _AddCardCategoryState createState() => _AddCardCategoryState();
}

class _AddCardCategoryState extends State<AddCardCategory>
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => AddCardInstitutionSearch()));
                    },
                    child: Container(
                      height: height,
                      width: widthone,

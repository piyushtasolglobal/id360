...
class InstitutionDetailsScreen extends StatefulWidget {
  Data data;
  InstitutionDetailsScreen(@required this.data);

  @override
  _InstitutionDetailsScreenState createState() => _InstitutionDetailsScreenState(this.data);
}

class _InstitutionDetailsScreenState extends State<InstitutionDetailsScreen>
    with TickerProviderStateMixin {
   Data data;
  _InstitutionDetailsScreenState(@required this.data);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildContainer("Country : ",data.country),
                SizedBox(
                  height: 20,
                ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => UserDynamicRegistrationFormScreen(data.id.toString())));
                    },
                  ),
                ),
              ],

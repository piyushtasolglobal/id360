...
class RegisterOtpScreen extends StatefulWidget {
  String otp='';
  String user_id='';
  RegisterOtpScreen(this.otp,this.user_id);

  @override
  _RegisterOtpScreenState createState() => _RegisterOtpScreenState(otp,user_id);
}
...
class _RegisterOtpScreenState extends State<RegisterOtpScreen>
  ...
  _RegisterOtpScreenState(this.otp,this.user_id);

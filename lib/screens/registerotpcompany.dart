...
class RegisterOtpScreenCompany extends StatefulWidget {
  String user_id='',otp='', name='', email='';
  bool alrady_logged_in=false;

  RegisterOtpScreenCompany(this.user_id, this.otp, this.alrady_logged_in,this.name, this.email);


  @override
  _RegisterOtpScreenCompanyState createState() => _RegisterOtpScreenCompanyState(user_id,otp);
}

class _RegisterOtpScreenCompanyState extends State<RegisterOtpScreenCompany>
  ...
  _RegisterOtpScreenCompanyState(this.user_id, this.otp);
  ...
  void check_val() async
  {
    ...
    {
      EasyLoading.showToast(AppConstants.txt_company_register,toastPosition: EasyLoadingToastPosition.bottom);
      _setSession();
    }
